(function () {
  ...
  var links = [
    ...
    { href: 'nichos.html', text: 'Nichos', children: [
      ...
      { href: 'cosmetica.html#proceso',     text: 'Proceso Comercial' },
      { href: 'cosmetica.html#llamada',     text: 'Estructura Llamada' },
      { href: 'cosmetica.html#pricing',     text: 'Precios' },
      { href: 'cosmetica.html#portal',      text: 'Portal del Cliente' },
      { href: 'cosmetica.html#retencion',   text: 'Retención' },
      { href: 'cosmetica.html#objeciones',  text: 'Objeciones' },
      { href: 'cosmetica.html#campanas',    text: 'Meta Ads' },
      { href: 'cosmetica.html#formatos',    text: 'Creativos' },
      { href: 'cosmetica.html#audiencias',  text: 'Audiencias' },
      { href: 'cosmetica.html#operacion',   text: 'Operación' }
    ]},
